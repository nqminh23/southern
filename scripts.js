...
const data = [
    { 
        ...
        description: "Vịnh Hạ Long nổi tiếng với cảnh sắc thiên nhiên tuyệt đẹp, bao gồm hàng ngàn hòn đảo đá vôi."
    },
    { 
        title: "Sa Pa", 
        region: "north", 
        ...
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeYFDyidHcm5vMU-WSUOrpK61jpdGeTelUxQ&s",
        description: "Sa Pa là một thị trấn thuộc tỉnh Lào Cai, với khí hậu mát mẻ và cảnh sắc núi non hùng vĩ."
    },
    { 
        title: "Huế", 
        region: "central", 
        ...
        description: "Huế là cố đô của Việt Nam, nổi tiếng với các di tích lịch sử và văn hóa độc đáo."
    },
    { 
        title: "Bánh xèo", 
        region: "central", 
        ...
        description: "Bánh xèo là một món ăn truyền thống của Việt Nam với lớp vỏ giòn rụm và nhân tôm thịt."
    },
    { 
        title: "Phở Hà Nội", 
        region: "north", 
        ...
        description: "Phở Hà Nội là món ăn truyền thống của thủ đô, với nước dùng đậm đà và bánh phở mềm mịn."
    },
    { 
        title: "Nha Trang", 
        region: "central", 
        ...
        description: "Nha Trang là thành phố biển nổi tiếng với bãi cát trắng và làn nước trong xanh."
    },
    { 
        title: "Đà Lạt", 
        region: "south", 
...
function advancedSearch() {
    ...
    var results = data.filter(function(item) {
        var matchesKeyword = keyword === "" || item.keywords.toLowerCase().includes(keyword);
